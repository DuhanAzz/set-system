        ...
        <div class="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div class="flex gap-6 text-sm font-bold uppercase tracking-widest text-slate-500">
                <?php if (!empty($landing['contact_whatsapp'])): ?>
                    <a href="https://wa.me/<?= preg_replace('/[^0-9]/', '', $landing['contact_whatsapp']) ?>" target="_blank" class="hover:text-theme transition" title="WhatsApp">
                ...
                <?php if (!empty($landing['contact_email'])): ?>
                    <a href="mailto:<?= htmlspecialchars($landing['contact_email']) ?>" class="hover:text-theme transition" title="Email">
                ...
                <?php if (!empty($landing['contact_instagram'])): ?>
                    ...
                    ?>
                    <a href="<?= htmlspecialchars($igLink) ?>" target="_blank" class="hover:text-theme transition" title="Instagram">
