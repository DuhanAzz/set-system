...
<div class="max-w-[210mm] mx-auto mb-6 space-y-4 no-print" id="main-content">
    <div class="bg-white p-4 rounded-xl shadow border border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="flex gap-2 bg-slate-100 p-1 rounded-lg">
            <a href="<?= getenv('APP_URL') ?>/roll/admin/medal_tally" class="bg-white shadow text-blue-700 px-4 py-1.5 rounded text-xs font-bold uppercase transition">
                🏆 Juara Umum (Klub)
            </a>
            <a href="<?= getenv('APP_URL') ?>/roll/admin/medal_tally/best_skater" class="text-gray-500 hover:text-gray-700 px-4 py-1.5 rounded text-xs font-bold uppercase transition">
                ...
                <td>
                    <?php if(empty($medalTally)): ?>
                        <div style="text-align:center; padding: 50px; font-weight: bold; color:#888; border: 2px dashed #ccc; margin-top: 15px;">
                            Belum ada data perolehan medali untuk event ini.
                        </div>
                    <?php else: ?>
                        <div class="block-tabel">
                            <div class="event-header">
                                <div class="eh-left-group">
                                    <div class="eh-number">REKAP KLUB / TIM</div>
                                    <div class="eh-date"><?= htmlspecialchars($eventInfo['start_date'] ?? '') ?></div>
                                </div>
                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-nama"><?= htmlspecialchars($row['club_name']) ?></td>
