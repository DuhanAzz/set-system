    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl p-8 border border-slate-200/50 shadow-2xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center">
                <div>
                    ...
                    <p class="text-slate-500 mt-2 font-medium">Laporan Tally Medali Klub dan Ekspor Data CSV/PDF</p>
                </div>
                <div class="mt-4 md:mt-0 flex flex-wrap gap-2 md:gap-4">
                    <a href="<?= getenv('APP_URL') ?>/roll/admin/reports/print_race_book" target="_blank" class="bg-emerald-600 hover:bg-emerald-500 text-slate-800 font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-emerald-500/25 transition-all flex items-center">
                        <span class="mr-2">🖨️</span> Cetak Race Book
                    </a>
                    <a href="<?= getenv('APP_URL') ?>/roll/admin/reports/print_result_book" target="_blank" class="bg-blue-600 hover:bg-blue-500 text-slate-800 font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-blue-500/25 transition-all flex items-center">
                        <span class="mr-2">🖨️</span> Cetak Buku Hasil
                    </a>
                    <a href="<?= getenv('APP_URL') ?>/roll/admin/reports/generate_start_list" class="bg-indigo-600 hover:bg-indigo-500 text-slate-800 font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-indigo-500/25 transition-all flex items-center">
        ...
        <div class="bg-slate-50/50 rounded-2xl border border-slate-200/50 shadow-xl overflow-hidden backdrop-blur-sm">
            <div class="px-6 py-4 border-b border-slate-200/50 bg-slate-50/80 flex justify-between items-center">
                <h3 class="text-lg font-bold text-slate-800 uppercase tracking-widest">Klasemen Medali Klub (Medal Tally)</h3>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-white/50 text-[10px] uppercase tracking-widest text-slate-500 border-b border-slate-200">
                            ...
                            <th class="p-4 font-bold w-32 text-center text-slate-800">Total</th>
                        </tr>
                    </thead>
                            ...
                            <tr class="hover:bg-slate-700/20 transition-colors <?= $rank <= 3 ? 'bg-slate-50/50' : '' ?>">
                                ...
                                <td class="p-4">
                                    <div class="flex items-center gap-3">
                                        <span class="font-bold text-slate-800 text-base"><?= htmlspecialchars($mt['club_name']) ?></span>
                                    </div>
                                </td>
                                <td class="p-4 text-center">
