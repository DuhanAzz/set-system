...
<div class="font-sans relative">
    ...
    <div class="mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div class="bg-white p-1 rounded-xl shadow-sm border border-slate-200 flex">
            <a href="<?= getenv('APP_URL') ?>/roll/master/settings/public_page" class="px-4 py-2 rounded-lg text-[10px] font-black uppercase transition text-slate-400 hover:bg-slate-50">Landing Page</a>
            <a href="<?= getenv('APP_URL') ?>/roll/master/settings/global_config" class="px-4 py-2 rounded-lg text-[10px] font-black uppercase transition bg-slate-900 text-white shadow-md">Global Config</a>
        </div>
    </div>
                ...
                <div class="p-8 flex-1 flex flex-col gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="support_email" value="<?= htmlspecialchars($config['support_email'] ?? '') ?>" class="w-full pl-10 pr-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 font-bold text-slate-700" placeholder="admin@setroll.com">
                        </div>
                    </div>
                </div>
