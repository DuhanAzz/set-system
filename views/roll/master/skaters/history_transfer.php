<?php 
// FILE: views/roll/master/skaters/history_transfer.php
?>
<div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
    ...
    <div class="flex gap-2">
        <div class="bg-white p-1 rounded-xl shadow-sm border border-slate-200 flex">
            <a href="<?= getenv('APP_URL') ?>/roll/master/skaters/index" class="px-4 py-1.5 rounded-lg text-[10px] font-black uppercase transition text-slate-400 hover:bg-slate-50">Daftar Skater</a>
            <a href="<?= getenv('APP_URL') ?>/roll/master/skaters/history_transfer" class="px-4 py-1.5 rounded-lg text-[10px] font-black uppercase transition bg-slate-900 text-white shadow-md">Riwayat Mutasi</a>
        </div>
    </div>
</div>
