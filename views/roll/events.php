...
<head>
    ...
    <style>
        ...
        .page-header { background-image: url('https://images.unsplash.com/photo-1517649763962-0c623066013b?q=80&w=2070&auto=format&fit=crop'); background-size: cover; background-position: center; }
    </style>
</head>
                    ...
                    <div class="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition duration-500 transform hover:-translate-y-2 border border-slate-100 flex flex-col h-full group">
                        ...
                        <div class="relative h-60 w-full bg-slate-200 overflow-hidden">
                            ...
                            <div class="absolute top-4 left-4 z-20 flex flex-col gap-2">
                                <span class="bg-orange-500 text-white text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded shadow-lg">Aktif</span>
                            </div>
                        ...
                        <div class="p-6 flex flex-col flex-grow relative">
                            ...
                            <p class="text-orange-600 font-bold text-sm mb-4 flex items-center gap-1 uppercase tracking-wider">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                <?= htmlspecialchars($ev['event_city']) ?>
                            </p>
                            
                            <div class="space-y-2 mb-6 text-sm text-slate-600 font-medium">
                            ...
                            <div class="mt-auto flex gap-2">
                                <a href="<?= getenv('APP_URL') ?>/roll/login" class="flex-1 bg-slate-900 hover:bg-orange-600 text-white text-center py-3 rounded-lg font-black uppercase tracking-widest text-xs transition">
                                    Daftar Sekarang
                                </a>
                            </div>
                        </div>
