                        ...
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-4 text-center">
                                <?php if(!empty($p['file_path'])): ?>
                                    <a href="<?= getenv('APP_URL') ?>/uploads/payments/<?= htmlspecialchars($p['file_path']) ?>" target="_blank" class="bg-blue-50 text-blue-600 hover:bg-blue-100 px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-wide border border-blue-100 inline-flex items-center gap-1 transition">
