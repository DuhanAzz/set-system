        ...
        <div class="max-w-screen-2xl flex items-center justify-between mx-auto w-full">
            ...
            <div class="flex items-center gap-12">
                <div class="hidden lg:flex items-center space-x-10">
                    ...
                    <a href="<?= getenv('APP_URL') ?>/swim/events" class="nav-link active text-blue-400">Jadwal Lomba</a>
    ...
    <main class="flex-grow py-20 px-6 max-w-screen-xl mx-auto w-full">
                ...
                <div class="bg-white rounded-3xl border border-slate-200 overflow-hidden hover:shadow-2xl transition-all duration-300 group flex flex-col sm:flex-row relative">
                    ...
                    <div class="w-full sm:w-3/5 p-6 md:p-8 flex flex-col justify-between relative z-10">
                            ...
                            <div class="mt-5 border-t border-slate-100 pt-4">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <?php foreach($documentsByEvent[$e['id']] as $doc): 
                                        ...
                                        $docPath = (strpos($doc['file_path'], 'http') === 0) ? $doc['file_path'] : rtrim(getenv('APP_URL'), '/') . '/' . ltrim($doc['file_path'], '/');
                                    ?>
                        ...
                        <div class="grid grid-cols-2 gap-3 mt-6">
                            <?php if($isOpen): ?>
                                <a href="<?= getenv('APP_URL') ?>/swim/login" class="py-3 px-2 rounded-xl flex items-center justify-center gap-2 bg-slate-900 text-white hover:bg-blue-600 transition-all uppercase text-[10px] font-black tracking-widest shadow-lg">
                                    <span>✍️</span> Daftar
                                </a>
                            <?php else: ?>
                            ...
                            <?php if ($e['is_result_published'] == 1): ?>
                                <a href="<?= getenv('APP_URL') ?>/swim/results?event_id=<?= $e['id'] ?>" class="py-3 px-2 rounded-xl flex items-center justify-center gap-2 bg-blue-50 border-2 border-blue-100 text-blue-600 hover:bg-blue-600 hover:text-white transition-all uppercase text-[10px] font-black tracking-widest">
        ...
        <?php else: ?>
            <div class="text-center py-24 border-2 border-dashed border-slate-200 rounded-3xl bg-white shadow-sm">
                ...
                <?php if(!empty($search)): ?>
                    <a href="<?= getenv('APP_URL') ?>/swim/events" class="inline-block mt-6 text-blue-600 text-xs font-black uppercase tracking-widest hover:underline">&larr; Tampilkan Semua</a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
